...
% BibLateX
%\usepackage[backend=biber, style=ieee, url=false, bibencoding=inputenc]{biblatex}
%\usepackage{csquotes}
...
%\usepackage{xcolor}
%\usepackage{listings}
\usepackage[colorinlistoftodos]{todonotes} % see http://tug.ctan.org/macros/latex/contrib/todonotes/todonotes.pdf
